...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"Dedicated to Saurabh Khandagale!",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String aboutText=
	"Stay Alert for Copy Right.\n It was Create on 29/02/2000 in Sai Compusys lab by Saurabh Khandagale    ";
}